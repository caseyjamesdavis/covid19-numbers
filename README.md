...
Simple analysis of the COVID-19 data supplied by the *Johns Hopkins University Center for Systems Science and Engineering* ([JHU CSSE](https://github.com/CSSEGISandData/COVID-19)) and the *New York Times* ([NYT](https://github.com/nytimes/covid-19-data)).  The data from this source tends to be about a day behind. 
